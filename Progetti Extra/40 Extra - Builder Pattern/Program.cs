...
/*public class Program
{
    public static void Main(string[] args)
    {
        ...
        ProdottoBuilderPattern notebook = new ProdottoBuilder()
            .ConId(1)
            .ConNome("Notebook Ultrabook 14\"")
            .ConPrezzo(1299.90m)
            .Build();

        ProdottoBuilderPattern mouse = new ProdottoBuilder()
            .ConId(2)
        ...
        UtenteBuilderPattern utente = new UtenteBuilder("Mario", "Rossi")
            .ConIndirizzo(indirizzo)
            .AggiungiOrdini([primoOrdine, secondoOrdine])
            .Build();
